module g_bucks::coin {
    ...
    struct CoinOwner has key, store { // Added 'store' ability
    ...
    fun init(witness: COIN, ctx: &mut TxContext) {
        ...
        transfer::public_transfer(owner, tx_context::sender(ctx));
    }

    /// Function to mint new G-Bucks
    ...
    /// This function allows only the owner to transfer G-Bucks.
